...
const EDITOR_SELECTOR = "[data-slate-editor],[role='textbox'][contenteditable='true']";
        ...
        component: () => (
            <div>
                ...
                <Forms.FormText style={{ marginBottom: 8 }}>
                    Transition duration (ms) — higher is slower and usually smoother.
                </Forms.FormText>
                <Slider
...
function buildCSS(): string {
    ...
    const shadow = glow > 0 ? `box-shadow: 0 0 ${glow}px ${glow * 0.75}px ${color}55;` : "";
...
${EDITOR_SELECTOR} { caret-color: transparent !important; }
`;
}

function isEditorFocused(): boolean {
    return !!document.activeElement?.closest(EDITOR_SELECTOR);
}
    ...
    return (
        <div className={Margins.bottom8}>
            <Forms.FormText style={{ marginBottom: 12 }}>
                Quick controls from the chat bar. The same values appear in the SmoothType plugin page in settings.
            </Forms.FormText>
            ...
            <SearchableSelect
                ...
                value={EASING_OPTIONS.find(o => o.value === settings.store.animationType)?.value}
                placeholder="Easing"
                maxVisibleItems={6}
                closeOnSelect
                onChange={(v: string) => {
...
export default definePlugin({
    name: "SmoothType",
    description: "Smooth animated caret while typing in Discord chat inputs.",
    tags: ["Chat", "Appearance"],
    authors: [{ name: "Eagle", id: 806795825522016276n }],
