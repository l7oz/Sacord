...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Orbitcord settings section",
        options: [
...
export default definePlugin({
    ...
    getInfoRows() {
        ...
        const rows = [`Orbitcord ${gitHashShort}${getVersionInfo()}`];
